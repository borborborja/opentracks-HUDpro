 ...
 * API and its own unit setting does NOT travel with it, so HUD Pro owns unit formatting. Units are
...
object UnitsStore {
    fun load(prefs: cat.hudpro.opentracks.data.prefs.ViewerPreferences): Units = Units(
