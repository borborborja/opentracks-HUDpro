...
fun difficultyLabel(d: cat.hudpro.opentracks.data.tracks.Difficulty): Int = when (d) {
    cat.hudpro.opentracks.data.tracks.Difficulty.EASY -> R.string.difficulty_easy
    cat.hudpro.opentracks.data.tracks.Difficulty.MODERATE -> R.string.difficulty_moderate
    cat.hudpro.opentracks.data.tracks.Difficulty.HARD -> R.string.difficulty_hard
    cat.hudpro.opentracks.data.tracks.Difficulty.VERY_HARD -> R.string.difficulty_very_hard
}
